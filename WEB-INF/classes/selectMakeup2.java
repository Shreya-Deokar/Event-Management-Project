...
@WebServlet("/selectMakeup2")

public class selectMakeup2 extends HttpServlet 
{
    private static final long serialVersionUID = 1L;
	public selectMakeup2() 
	{
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
			...
			try
			{
					String no_per = request.getParameter("no_per");
					...
					String query = "update Event set no_of_person='"+no_per+"'  where eid='"+session.getAttribute("id")+"'";
