...
@WebServlet("/selectPhotographer")

public class selectPhotographer extends HttpServlet 
{
    private static final long serialVersionUID = 1L;
	public selectPhotographer() 
	{
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        request.getRequestDispatcher("/selectMakeup.jsp").forward(request, response);
	}
}
